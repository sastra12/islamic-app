    ...
    <default-container>
      ...
      >
        <div class="p-3 flex items-center justify-between">
          ...
          <h3 class="font-sans text-white mx-auto">Hadis Web</h3>
        </div>
      </div>
      ...
      <div class="h-screen">
        ...
        >
          <router-link :to="`hadith/${hadith.slug}`">
            <div class="flex">
              <svg
              ...
              <div class="ml-3 my-auto">
                <h3 class="text-teal-500">{{ hadith.name }}</h3>
              </div>
              <div class="ml-auto my-auto">
                <p class="text-xs text-teal-500">Total: {{ hadith.total }}</p>
              </div>
            </div>
          </router-link>
        </div>
